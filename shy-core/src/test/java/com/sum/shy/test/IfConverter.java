...
public class IfConverter /* extends */ /* DefaultConverter */ {

	public int convert(StringBuilder sb, String block, String indent, CtClass clazz, CtMethod method, Line line,
			Stmt stmt) {
