...
public class ConfigUtils implements EnvironmentAware {
    ...
    public static String getInputPath() {
        return ConfigUtils.getProperty(Argument.INPUT_PATH);
    }

    public static String getOutputPath() {
        return ConfigUtils.getProperty(Argument.OUTPUT_PATH);
    }

    public static String getClassPaths() {
        return ConfigUtils.getProperty(Argument.CLASS_PATHS);
    }
